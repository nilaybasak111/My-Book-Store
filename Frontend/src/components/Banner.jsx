...
function Banner() {
  return (
    <>
      <div className="max-w-screen-2xl container my-10 md:my-0 mx-auto md:px-20 px-4 flex flex-col md:flex-row">
        <div className="order-2 md:order-1 w-full md:w-1/2 mt-1 md:mt-14">
