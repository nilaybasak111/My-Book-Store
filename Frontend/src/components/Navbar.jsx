...
export default function Navbar() {
  ...
  // This Function change the theme dark to light or light to dark
  ...
  // This Function add Scroll Shadow Efect in Navbar
        ...
        <div className="navbar-end space-x-3">
          ...
          <div className="hidden md:block">
            <label className="px-3 py-2 border rounded-md flex items-center gap-2">
              <input
                type="text"
                className="grow px-2 py-1 outline-none dark:bg-slate-900 dark:text-white"
                placeholder="Search"
              />
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            <a className="bg-black text-white m-1 p-2 rounded-md hover:bg-slate-800 duration-500 cursor-pointer"
